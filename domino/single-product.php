				...
				<div class="col-lg-5 offset-lg-1">
					<div class="s_product_text">
						...
						<div class="product_count">
              				...
              				<button style="bottom: 13px; right: 252px;" onclick="var result = document.getElementById('sst'); var sst = result.value; if( !isNaN( sst )) result.value++;return false;"
							 class="reduced items-count" type="button"><i class="fas fa-plus"></i></button>
							<input style="margin-left: 5px;" type="text" name="qty" id="sst" size="2" maxlength="12" value="1" title="Quantity:" class="input-text qty">
							<button style="bottom: 13px; left: 60px;" onclick="var result = document.getElementById('sst'); var sst = result.value; if( !isNaN( sst ) &amp;&amp; sst > 0 ) result.value--;return false;"
               				class="increase items-count" type="button"><i class="fas fa-minus"></i></button>
								...
								<div class="review_item border-bottom">
									<div class="media">
										...
										if ($tow['email'] == $_SESSION['admin']) { ?>
											<a class="reply_btn"  href="single-product.php?id=<?=$id ?>&cate=<?=$cate ?>&id_comment=<?= $row['id'] ?>" onclick="load_trang()">Xóa</a>
										<?php
										}
										?>
										</div>
