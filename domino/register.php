...
if (isset($_POST['register'])) {
	...
	if ($cout_mail->rowCount() > 0) {
		...
		$error = "Đăng ký thành công.<br>Mời bạn đăng nhập!";
					...
					<div class="login_form_inner register_form_inner">
						...
						<form method="POST" class="row login_form" action="#/" id="register_form" enctype="multipart/form-data">
							<div class="col-md-12 form-group">
								<input type="text" class="form-control" id="name" name="name" placeholder="Họ tên" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Họ và tên'">
							</div>
							<div class="col-md-12 form-group">
							...
							<div class="col-md-12 form-group">
              				...
              				<div class="col-md-12 form-group">
								<input type="password" class="form-control" id="password" name="pass" placeholder="Password" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Mật khẩu'">
              				</div>
              				<!-- <div class="col-md-12 form-group">
