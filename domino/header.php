              ...
              <li class="nav-item submenu dropdown">
                ...
                if (isset($_SESSION['admin'])) { ?>
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li class="nav-item"><a class="nav-link" href="profile.php?email=<?= $_SESSION['admin'] ?>">Tài khoản</a></li>
                ...
                <?php
                  ...
                  <ul class="dropdown-menu">
                    <li class="nav-item"><a class="nav-link" href="profile.php?email=<?= $_SESSION['user'] ?>">Tài khoản</a></li>
                    <li class="nav-item"><a class="nav-link" href="logout.php" onclick="return alert('Bạn chắc chắn muốn đăng xuất chứ ?')">Đăng Xuất</a></li>
                  </ul>
                <?php
                } else { ?>
