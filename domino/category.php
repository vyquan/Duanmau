    ...
    <div class="row">
      ...
      <div class="col-xl-9 col-lg-8 col-md-7">
        ...
        <div class="filter-bar d-flex flex-wrap align-items-center">
          ...
          <div>
            <form action="search.php" method="POST" class="input-group filter-bar-search">
              <input name="name" type="text" placeholder="Tìm kiếm">
              <div class="input-group-append">
                <button name="search" type="button"><i class="ti-search"></i></button>
              </div>
            </form>
          </div>
        </div>
        ...
        <section class="lattest-product-area pb-40 category-list">
          <div class="row">
            <?php
            foreach (selectDb("SELECT * FROM product ORDER BY id DESC LIMIT $tin,$data") as $row) { { ?>
                <div style="margin-bottom: 10px;" class="col-md-6 col-lg-3 shw">
                  <div class="card text-center card-product "><br>
                    ...
                    <div class="card-body">
                      ...
                      <del><?= number_format($row['price']) ?>đ</del>  <span class="badge badge-danger"> -<?= $row['sale'] ?>%</span>
